    ...
    <div className="bg-background dark:bg-background-dark min-h-screen transition-colors duration-200">
      <section className="section-container py-12 px-4 md:px-6">
        ...
        <div className="mb-8 flex justify-center">
          <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-2 md:p-4 inline-flex flex-wrap justify-center">
            {tabs.map(tab => (
              <button
                key={tab.id}
        ...
        >
          {activeTab === 'data' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold mb-4 text-text-color dark:text-text-color-dark">Data Sources</h2>
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Primary Dataset: World Happiness Report</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Data Collection Methodology</h4>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Key Metrics</h4>
              ...
              <h4 className="font-medium mb-2 text-text-color dark:text-text-color-dark">Explanatory Factors</h4>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">GDP per Capita</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Economic output per person, log-transformed to account for diminishing returns</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">Social Support</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Having someone to count on in times of trouble</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">Healthy Life Expectancy</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Number of years of healthy life expected at birth</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">Freedom</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Freedom to make life choices without external constraints</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">Generosity</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Charitable donations and helping behavior</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="font-medium text-primary dark:text-blue-400">Corruption Perception</p>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Public perception of corruption in government and business</p>
                </div>
              </div>
              
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Supplementary Datasets</h3>
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Human Development Index (HDI)</h4>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Population Data</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Additional World Bank Indicators</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
          ...
          {activeTab === 'preprocessing' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold mb-4 text-text-color dark:text-text-color-dark">Data Preprocessing</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Preprocessing Pipeline</h3>
              <div className="relative overflow-hidden">
                <div className="absolute left-4 h-full w-0.5 bg-gray-200 dark:bg-gray-600"></div>
                <div className="space-y-6 pl-10 relative">
                  <div>
                    <div className="absolute left-3.5 -translate-x-1/2 w-7 h-7 rounded-full bg-primary dark:bg-blue-600 text-white flex items-center justify-center">1</div>
                    <h4 className="font-medium text-lg mb-2 text-text-color dark:text-text-color-dark">Data Collection and Initial Inspection</h4>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    <div className="absolute left-3.5 -translate-x-1/2 w-7 h-7 rounded-full bg-primary dark:bg-blue-600 text-white flex items-center justify-center">2</div>
                    <h4 className="font-medium text-lg mb-2 text-text-color dark:text-text-color-dark">Data Cleaning</h4>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    <div className="absolute left-3.5 -translate-x-1/2 w-7 h-7 rounded-full bg-primary dark:bg-blue-600 text-white flex items-center justify-center">3</div>
                    <h4 className="font-medium text-lg mb-2 text-text-color dark:text-text-color-dark">Data Integration</h4>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    <div className="absolute left-3.5 -translate-x-1/2 w-7 h-7 rounded-full bg-primary dark:bg-blue-600 text-white flex items-center justify-center">4</div>
                    <h4 className="font-medium text-lg mb-2 text-text-color dark:text-text-color-dark">Feature Engineering</h4>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                  ...
                  <div>
                    <div className="absolute left-3.5 -translate-x-1/2 w-7 h-7 rounded-full bg-primary dark:bg-blue-600 text-white flex items-center justify-center">5</div>
                    <h4 className="font-medium text-lg mb-2 text-text-color dark:text-text-color-dark">Data Structuring for Visualization</h4>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
              ...
              <h3 className="text-xl font-medium mt-10 mb-2 text-text-color dark:text-text-color-dark">Technical Implementation</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                The preprocessing pipeline was implemented using Python, with the following libraries playing key roles:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Data Processing Libraries</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Data Output</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
          ...
          {activeTab === 'visualization' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold mb-4 text-text-color dark:text-text-color-dark">Visualization Approaches</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Design Principles & Philosophy</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Visual Clarity</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">User-Centered Design</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Interactivity</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Narrative Elements</h4>
                  <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Color System</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Visualization Types</h3>
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Interactive Choropleth Map</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Factor Correlation Analysis</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Time Series Visualizations</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Comparative Visualizations</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Technical Implementation</h3>
              <p className="text-gray-600 dark:text-gray-300">
                We leveraged several key technologies to implement our visualizations:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">D3.js</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Three.js</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Framer Motion</h4>
                  <p className="text-gray-600 dark:text-gray-300">
          ...
          {activeTab === 'analysis' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold mb-4 text-text-color dark:text-text-color-dark">Analytical Methods</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Statistical Approaches</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Correlation Analysis</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Time Series Analysis</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Comparative Analysis</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Factor Contribution Analysis</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Advanced Analytical Techniques</h3>
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Interpretation Frameworks</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                To contextualize our findings, we developed several interpretive frameworks:
              </p>
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Happiness Efficiency Model</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Resilience Index</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  <h4 className="font-medium text-primary dark:text-blue-400 mb-2">Factor Balance Theory</h4>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">Limitations and Considerations</h3>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-6">
                <p className="text-gray-600 dark:text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-medium mt-6 mb-2 text-text-color dark:text-text-color-dark">References and Further Reading</h3>
              <div className="space-y-3">
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <a href="https://worldhappiness.report/" target="_blank" rel="noopener noreferrer" className="text-primary dark:text-blue-400 hover:underline font-medium">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <a href="https://hdr.undp.org/" target="_blank" rel="noopener noreferrer" className="text-primary dark:text-blue-400 hover:underline font-medium">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <a href="https://data.worldbank.org/" target="_blank" rel="noopener noreferrer" className="text-primary dark:text-blue-400 hover:underline font-medium">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                  <a href="https://github.com/com-480-data-visualization/HappiScope" target="_blank" rel="noopener noreferrer" className="text-primary dark:text-blue-400 hover:underline font-medium">
