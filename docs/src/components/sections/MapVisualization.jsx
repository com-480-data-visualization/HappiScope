      ...
      <section className="section-container py-12">
        ...
        >
          <div className="bg-white shadow-md rounded-lg p-4">
            <h3 className="text-lg font-medium mb-3">Select Year:</h3>
        ...
        >
          <div className="bg-gray-100 rounded-md h-96 flex items-center justify-center mb-6 overflow-hidden relative">
            ...
            <div className="absolute top-3 right-3 bg-white/80 backdrop-blur-sm px-3 py-1 rounded text-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div>
              <select 
                className="bg-gray-100 rounded-md px-4 py-2 border border-gray-300"
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          <motion.div 
            ...
            className="card"
          >
            <h3 className="text-xl font-semibold mb-4">Color Legend</h3>
            <div className="flex flex-col gap-2">
              <div className="flex items-center">
                <div className="w-8 h-4 bg-green-600 rounded-sm mr-2"></div>
                <span>Very Happy (8-10)</span>
              </div>
              <div className="flex items-center">
          ...
          <motion.div 
            ...
            className="card"
          >
            <h3 className="text-xl font-semibold mb-4">Selected Region Insights</h3>
          ...
          <motion.div 
            ...
            className="card"
          >
            <h3 className="text-xl font-semibold mb-4">Data Completeness</h3>
            <p className="text-gray-600 mb-4">
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <h4 className="font-medium text-sm mb-2">Top 3 Missing Data Regions</h4>
        ...
        <motion.div 
          ...
          className="mt-12"
        >
          <h2 className="text-2xl font-semibold mb-6 text-center">Key Global Insights for {selectedYear}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow p-5 border-t-4 border-green-500">
              <h3 className="font-medium mb-2">Happiest Regions</h3>
            ...
            <div className="bg-white rounded-lg shadow p-5 border-t-4 border-yellow-500">
              <h3 className="font-medium mb-2">Top Improving Countries</h3>
              <p className="text-gray-600 text-sm mb-3">
