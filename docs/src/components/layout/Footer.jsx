      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5">
            ...
            >
              <Link to="/" className="flex items-center space-x-2 mb-6">
                <img src={happiscope} alt="HappiScope Logo" className="h-10" />
              ...
              <p className="text-gray-300 text-lg mb-6 leading-relaxed max-w-lg">
                Exploring the multidimensional nature of global happiness
                through sophisticated visual analysis of World Happiness Report
                data from 2015-2024.
              </p>
          ...
          <div className="md:col-span-2">
            ...
            >
              <h3 className="text-lg font-bold mb-5 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">
                Explore
              </h3>
        ...
        {/* Disclaimer about map visualization */}
        <div className="mt-12 border-t border-gray-700 pt-8">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <div className="bg-gray-700/50 rounded-lg p-4 text-sm text-gray-300 mb-8">
              <p className="leading-relaxed">
                <span className="font-semibold text-white">Disclaimer:</span>{" "}
                The maps and visualizations presented in this project are for
                academic and educational purposes only. The geographical
                representations, borders, names, and designations used do not
                imply any opinion, endorsement, or political position on the
                part of the authors regarding the legal status of any country,
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} HappiScope | Created for COM-480 Data
            Visualization at EPFL
          </p>
        </div>
      </div>
    </footer>
